...
if __name__ == "__main__":
    ...
    parser.add_argument("--output_dir", type=str, default="chengdu", help="Output directory.")
    parser.add_argument("--traffic_df_filename", type=str, default="original_data.npz", help="Raw traffic readings.",)
    ...
    df = np.load("original_data.npz")['data']
